                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="space-x-6 w-3/4">
                        <label class="inline-flex items-center">
                            <input type="radio" name="nivel-estilos" value="basico" class="nivel-radio form-radio h-5 w-5 text-blue-600" data-slug="estilos" data-nivel="basico">
                            <span class="ml-2 text-gray-700 dark:text-gray-300">🔹 Básico</span>
                        </label>

                        <label class="inline-flex items-center">
                            <input type="radio" name="nivel-estilos" value="intermedio" class="nivel-radio form-radio h-5 w-5 text-green-600" data-slug="estilos" data-nivel="intermedio">
                            <span class="ml-2 text-gray-700 dark:text-gray-300">🔹 Intermedio</span>
                        </label>

                        <label class="inline-flex items-center">
                            <input type="radio" name="nivel-estilos" value="avanzado" class="nivel-radio form-radio h-5 w-5 text-purple-600" data-slug="estilos" data-nivel="avanzado">
