...
<div class="flex md:flex-row">
  <article id="cap04" class="w-3/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
    <h3 class="text-3xl font-semibold font-roboto text-gray-700 dark:text-blue-300 mb-4">Capítulo 1: </h3>
    ...
    <div class="mt-8 p-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
      ...
      <ol class="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
        <li><a href="./ejercicios/intermedio/estilos/4" target="_blank">Ejercicio 4</a></li>
        <li><a href="./ejercicios/intermedio/estilos/5" target="_blank">Ejercicio 5</a></li>
        <li><a href="./ejercicios/intermedio/estilos/6" target="_blank">Ejercicio 6</a></li>
      </ol>
    </div>
  </article>
