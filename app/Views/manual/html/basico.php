<div class="space-y-8">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">📚 Nivel Básico - HTML</h2>
    
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Capítulo 1: Sintaxis Básica</h3>
        <p class="text-gray-600 dark:text-gray-300 mb-4">Aprende los fundamentos de HTML.</p>
        <pre class="bg-gray-100 dark:bg-gray-900 p-4 rounded"><code><?php
echo "Hola, mundo!";
?></code></pre>
    </div>
