<div class="w-full mt-5 mb-10 p-lg-6 p-md-6">
	<h1 class="underline font-mono text-lg text-blue-600 dark:text-pink-600">EJERCICIO 03</h1>
	<h2 class="text-3xl text-dark-600 dark:text-green-400 my-6">Cómo añadir tipografías personalizadas</h2>
