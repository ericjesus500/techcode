...
<div class="container mx-auto my-8">
  <div class="flex md:flex-row">
    <article id="cap08" class="w-3/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
      ...
      <!-- 8.5 Configuraciòn avanzafda del núcleo -->
      <section>
        <h2 class="mt-10 font-mono text-2xl text-gray-300 dark:text-yellow-400">8.5 Configuraciòn avanzafda del núcleo</h2>
