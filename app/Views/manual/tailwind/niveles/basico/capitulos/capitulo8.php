<!-- Capitulo 08: Directivas de Tailwind: @apply & @layer -->
<hr>
  ...
  <div class="flex md:flex-row">
    <section class="w-3/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
      ...
      <article class="mt-8 p-6">
        ...
        <!-- Directivas implícitas y funcionalidades integradas -->
        <section>
        ...
        <section>
          ...
          <!-- Directiva @apply en v4: Conceptos teóricos -->
          <article>
          ...
          <!-- Directiva @layer en v4: Conceptos teóricos -->
          <article>
          ...
          <!-- Resumen de los cambios en @apply y @layer -->
          <article>
