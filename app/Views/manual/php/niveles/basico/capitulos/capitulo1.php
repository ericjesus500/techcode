...
<article id="cap1" class="mx-auto w-full mt-4">
  <div class="flex md:flex-row">
    <section class="w-3/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
      <h1 class="text-3xl font-semibold font-roboto text-gray-700 dark:text-blue-300 mb-4">Capítulo <?= $capitulo; ?>: FUNDAMENTOS DE PHP</h1>
      ...
      <article class="bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
        ...
        <!-- Ejercicios -->
        <section class="mt-8 p-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
