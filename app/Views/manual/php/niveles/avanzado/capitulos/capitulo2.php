  ...
  <article id="cap04" class="w-3/4 bg-white dark:bg-gray-800 p-3 rounded-lg shadow md:box-border lg:box-border">
    ...
    <div class="mt-8 p-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
      ...
      <ol class="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
        <li><a href="./ejercicios/avanzado/php/4" target="_blank"></a>Ejercicio 4</li>
        <li><a href="./ejercicios/avanzado/php/5" target="_blank"></a>Ejercicio 5</li>
        <li><a href="./ejercicios/avanzado/php/6" target="_blank"></a>Ejercicio 6</li>
      </ol>
    </div>
  </article>
