<div class="space-y-8">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">📚 Nivel Básico - GIT</h2>
    
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-200 mb-4">Capítulo 1: Sintaxis Básica</h3>
        <p class="text-gray-600 dark:text-gray-300 mb-4">Aprende los fundamentos de GIT.</p>
    ...
    <div class="mt-8 p-6 bg-blue-50 dark:bg-blue-900/30 rounded-lg">
        ...
        <ol class="list-decimal list-inside space-y-2 text-gray-700 dark:text-gray-300">
            <li><a href="/ejercicios/basicos/git/01" target="_blank">ejercicio 01.</a></li>
            <li><a href="/ejercicios/basicos/git/01" target="_blank">ejercicio 02.</a>.</li>
        </ol>
    </div>
</div>