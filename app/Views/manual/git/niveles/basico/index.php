<section class="space-y-8 max-w-full min-w-0">
  ...
  <div id="lista-capitulos" class="mx-auto p-3 rounded border border-gray-600 bg-yellow-600 dark:bg-yellow-50 dark:border-gray-300
    ...
    <ul class="capitulos flex flex-col">
      <li><a class="my-2 dark:text-gray-700 cursor-pointer" data-curso="git" data-nivel="basico" data-capitulo="1">Capitulo 1: </a></li>
      <li><a class="my-2 dark:text-gray-700 cursor-pointer" data-curso="git" data-nivel="basico" data-capitulo="2">Capitulo 2: </a></li>
      <li><a class="my-2 dark:text-gray-700 cursor-pointer" data-curso="git" data-nivel="basico" data-capitulo="3">Capitulo 3: </a></li>
      <li><a class="my-2 dark:text-gray-700 cursor-pointer" data-curso="git" data-nivel="basico" data-capitulo="4">Capitulo 4: </a></li>
    </ul>
  </div>
