...
<div class="mb-8 p-4 bg-white dark:bg-gray-800 rounded-lg shadow flex flex-col sm:flex-row gap-4 items-center">
    <h2 class="text-2xl font-bold text-gray-800 dark:text-white">📘 Manual de GIT</h2>
    ...
    <div class="prose dark:prose-invert max-w-none">
        ...
        <div class="flex space-x-6 mb-8">
            <label class="inline-flex items-center">
                <input type="radio" name="nivel-git" value="basico" class="nivel-radio form-radio h-5 w-5 text-blue-600" data-slug="git" data-nivel="basico">
                <span class="ml-2 text-gray-700 dark:text-gray-300">🔹 Básico</span>
            </label>

            <label class="inline-flex items-center">
                <input type="radio" name="nivel-git" value="intermedio" class="nivel-radio form-radio h-5 w-5 text-green-600" data-slug="git" data-nivel="intermedio">
                <span class="ml-2 text-gray-700 dark:text-gray-300">🔹 Intermedio</span>
            </label>

            <label class="inline-flex items-center">
                <input type="radio" name="nivel-git" value="avanzado" class="nivel-radio form-radio h-5 w-5 text-purple-600" data-slug="git" data-nivel="avanzado">
