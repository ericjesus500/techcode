...
<body class="flex-col font-sans antialiased text-gray-800 dark:text-gray-200 bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
  <header class="fixed top-0 left-0 right-0 z-20 bg-gray-800 dark:bg-gray-900 text-white shadow-md">
    <div class="flex flex-col sm:flex-col md:flex-row lg:flex-row mx-auto">
      <!-- Zona 1: Ancho fijo (igual al sidebar) -->
      <div class="w-64 sm:w-64 flex items-center justify-center py-3 bg-gray-900 dark:bg-gray-900 mx-auto">
        <a href="/" class="text-xl font-bold text-blue-400">TechCode</a>
      </div>

      <!-- Zona 2: Ancho dinámico (igual al contenido) -->
      <div class="flex flex-row sm:w-full md:flex-1 lg:flex-1 xl:flex-1 md:px-4 md:py-3 items-center justify-between space-x-4">
        ...
        <div class="relative w-auto md:w-full max-w-md">
